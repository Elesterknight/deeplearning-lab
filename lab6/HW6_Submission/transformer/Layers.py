...
class DecoderLayer_Flash(nn.Module):
    ...
    def forward(self, dec_input, dec_seq_lens, enc_output, enc_seq_lens, kv_cache=None):
        # 1. Self-Attention
        dec_output = self.slf_attn(dec_input, dec_seq_lens, kv_cache=kv_cache)
        
        # 2. Encoder-Decoder Attention
        dec_output = self.enc_attn(dec_output, enc_output, dec_seq_lens, enc_seq_lens)
